...
export class ProductGenerator {
  ...
  async generateProductsForSearch(searchTerm: string, maxProducts: number = 5): Promise<Product[]> {
    ...
    try {
      ...
      // 天马行空的系统提示词
      const systemPrompt = `你是一个充满想象力的跨时空商品生成专家，能够生成各种奇幻、科幻、古代、未来世界的商品。

要求：
1. 严格按照JSON格式返回，不要包含任何其他文字
2. 商品要天马行空，不局限于现实生活用品
3. 可以包含古代、未来、魔法世界、科幻、奇幻等各种类型
4. 价格要符合商品的价值和稀有度
5. 描述要详细且富有想象力
6. 标签要准确反映商品特性
7. 使用合适的emoji图标
...
商品类型示例：
- 古代：青铜器、丝绸、玉器、古剑、香炉等
- 未来：时光机、星际通讯器、纳米机器人、悬浮车等
- 魔法：魔法杖、魔法药水、飞行扫帚、魔法宝石等
- 科幻：激光剑、星际战舰、机器人、传送门等
- 奇幻：龙鳞护甲、精灵弓箭、矮人战斧、魔法卷轴等
- NSFW：情趣内衣、按摩棒、情趣手铐、情趣润滑液、情趣眼罩、情趣跳蛋、情趣蜡烛、情趣羽毛、情趣冰块、情趣口球等
  ...
  "products": [
    {
      ...
      // 天马行空的用户提示词
      const userPrompt = `请根据搜索词"${searchTerm}"生成${maxProducts}个天马行空的商品，可以是古代、未来、魔法世界、科幻、奇幻等各种类型。

商品要求：
- 价格：根据商品稀有度和价值设定，可以是50-50000元之间
- 原价：比现价高20-100%
- 类别：可以是古代文物、未来科技、魔法物品、科幻装备、奇幻武器、异世界商品等
- 评分：4.0-5.0之间
- 评论数量：10-10000之间（稀有商品评论较少）
- 库存：1-1000之间（稀有商品库存较少）
- 折扣：10-80%之间
- 描述要富有想象力，体现商品的特殊性和背景故事
- 使用合适的emoji图标
